/*
 * This file is to perform energy decomposition for a given set of coordinates
 * It is coded by Wenjin Li
 * Please cite the following papers in case of using the file.
